...
public class AutoStaircase extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // Find the stair item
        FindItemResult result = InvUtils.findInHotbar(stairItem.get());
        ...
        boolean placed1 = BlockUtils.place(stairPos, result, true, 0, true);
        boolean placed2 = BlockUtils.place(secondPos, result, true, 0, true);
