...
public class LavaHud extends HudElement {
    public static final HudElementInfo<LavaHud> INFO = new HudElementInfo<>(AddonTemplate.HUD_GROUP, "lava-hud", "Shows nearby lava sources and flowing lava.", LavaHud::new);
