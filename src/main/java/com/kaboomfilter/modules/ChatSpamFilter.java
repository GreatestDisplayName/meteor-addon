package com.kaboomfilter.modules;
...
public class ChatSpamFilter extends Module {
    ...
    public ChatSpamFilter() {
        super(AddonTemplate.CATEGORY, "chat-spam-filter", "Filters out NBT and format string spam from kaboom.pw");
    }
